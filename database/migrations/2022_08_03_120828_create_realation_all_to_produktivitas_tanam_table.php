...
class CreateRealationAllToProduktivitasTanamTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('tb_produktivitas_tanam', function (Blueprint $table) {
    ...
    public function down()
    {
        Schema::table('tb_produktivitas_tanam', function (Blueprint $table) {
            ...
            $table->dropForeign('tb_produktivitas_kecamatan_id_foreign');
