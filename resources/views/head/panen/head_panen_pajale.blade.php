        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <br>
                    <br>
                    <form id="form_pdf" action="{{ route('head.panen.pdf_panen_pajale') }}" method="get"
                        style="display: none;">
                        @csrf
        ...
        @push('scripts')
            ...
            <script>
                ...
                $(function() {
                    ...
                    $(document).off("click", "#btn-search")
                        .on("click", "#btn-search", function(e) {
                            ...
                            $("th#prov").html(null);
                            $("th#harga").html(null);
                            table.ajax.url("{{ route('head.head_panen_pajale.data') }}?tanggal_awal=" + p_tanggal_awal +
                ...
                $('.export_pdf').click(function() {
                    // var url = "{{ route('head.panen.pdf_panen_pajale') }}";
