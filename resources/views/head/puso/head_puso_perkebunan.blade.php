        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <br>
                    <br>
                    <form id="form_pdf" action="{{ route('head.puso.pdf_puso_perkebunan') }}" method="get"
                        style="display: none;">
                        @csrf
            ...
            <script>
                $(function() {
                    table = $('.table').DataTable({
                        ...
                        autoWidth: false,
                        ajax: {
                            url: '{{ route('head.head_puso_perkebunan.data') }}',
                        },
                        columns: [{
                                data: 'DT_RowIndex',
                                searchable: false,
                    ...
                    $(document).off("click", "#btn-search")
                        .on("click", "#btn-search", function(e) {
                            ...
                            $("th#prov").html(null);
                            $("th#harga").html(null);
                            table.ajax.url("{{ route('head.head_puso_perkebunan.data') }}?tanggal_awal=" +
