        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <br>
                    <br>
                    <form id="form_pdf" action="{{ route('head.tanam.pdf_tanam_perkebunan') }}" method="get" style="display: none;">
                        @csrf
            ...
            <script>
                ...
                $(function() {
                    table = $('.table').DataTable({
                        ...
                        autoWidth: false,
                        ajax: {
                            url: '{{ route('head.head_tanam_perkebunan.data') }}',
                        },
                        columns: [
                    ...
                    .on("click","#btn-search",function (e) {
                        ...
                        $("th#luas").html(null);
                        table.ajax.url( "{{ route('tanam_perkebunan.data') }}?tanggal_awal="+p_tanggal_awal+"&tanggal_akhir="+p_tanggal_akhir ).load();
                ...
                $('.export_pdf').click(function() {
                    // var url = "{{ route('head.tanam.pdf_tanam_perkebunan') }}";
