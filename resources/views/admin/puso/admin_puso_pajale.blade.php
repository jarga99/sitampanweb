        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <form id="form_pdf" action="{{ route('admin.puso.pdf_puso_pajale') }}" method="get"
                        style="display: none;">
                        @csrf
            ...
            <script>
                $(function() {
                    table = $('.table').DataTable({
                        ...
                        autoWidth: false,
                        ajax: {
                            url: '{{ route('admin.admin_puso_pajale.data') }}',
                        },
                        columns: [
                            // {
                            //     data: 'select_all',
                    ...
                    $(document).off("click", "#btn-search")
                        .on("click", "#btn-search", function(e) {
                            ...
                            $("th#prov").html(null);
                            $("th#harga").html(null);
                            table.ajax.url("{{ route('admin.admin_puso_pajale.data') }}?tanggal_awal=" +
                ...
                function addForm() {
                    var url = "{{ route('admin.puso.create_pajale') }}";
