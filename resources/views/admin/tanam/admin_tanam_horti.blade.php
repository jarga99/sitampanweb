        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <form id="form_pdf" action="{{ route('admin.tanam.pdf_tanam_horti') }}" method="get" style="display: none;">
                        @csrf
            ...
            <script>
                ...
                $(function() {
                    table = $('.table').DataTable({
                        ...
                        autoWidth: false,
                        ajax: {
                            url: '{{ route('admin.admin_tanam_horti.data') }}',
                        },
                        columns: [
                    ...
                    $(document).off("click", "#btn-search")
                        .on("click", "#btn-search", function(e) {
                            ...
                            $("th#luas").html(null);
                            table.ajax.url("{{ route('admin.admin_tanam_horti.data') }}?tanggal_awal=" +
                                p_tanggal_awal +
                ...
                function addForm() {
                    var url = "{{ route('admin.tanam.create_horti') }}";
                ...
                $('.export_pdf').click(function() {
                    // var url = "{{ route('admin.tanam.pdf_tanam_horti') }}";
