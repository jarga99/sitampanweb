        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <form id="form_pdf" action="{{ route('admin.panen.pdf_panen_horti') }}" method="get" style="display: none;">
                        @csrf
                ...
                $(function() {
                    ...
                    $(document).off("click", "#btn-search")
                        .on("click", "#btn-search", function(e) {
                            ...
                            $("th#prov").html(null);
                            $("th#harga").html(null);
                            table.ajax.url("{{ route('admin.admin_panen_horti.data') }}?tanggal_awal=" + p_tanggal_awal +
