        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <form id="form_pdf" action="{{ route('admin.panen.pdf_panen_horti') }}" method="get"
                        style="display: none;">
                        @csrf
            ...
            @includeIf('admin.panen.form_add_horti')
            ...
            <script>
                $(function() {
                    table = $('.table').DataTable({
                        ...
                        autoWidth: false,
                        ajax: {
                            url: '{{ route('admin.admin_panen_horti.data') }}',
                        },
                        columns: [
                    ...
                    $(document).off("click", "#btn-search")
                        .on("click", "#btn-search", function(e) {
                            ...
                            $("th#prov").html(null);
                            $("th#harga").html(null);
                            table.ajax.url("{{ route('admin.admin_panen_horti.data') }}?tanggal_awal=" +
                                p_tanggal_awal +
                ...
                function addForm() {
                    var url = "{{ route('admin.panen.create_horti') }}";
                ...
                $('.export_pdf').click(function() {
                    // var url = "{{ route('admin.panen.pdf_panen_horti') }}";
