        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <form id="form_pdf" action="{{ route('admin.panen.pdf_panen_perkebunan') }}" method="get"
                        style="display: none;">
                        @csrf
            ...
            @includeIf('admin.panen.form_add_perkebunan')
        ...
        @push('scripts')
            ...
            <script>
                ...
                $(function() {
                    ...
                    $(document).off("click", "#btn-search")
                        .on("click", "#btn-search", function(e) {
                            ...
                            $("th#prov").html(null);
                            $("th#harga").html(null);
                            table.ajax.url("{{ route('admin.admin_panen_perkebunan.data') }}?tanggal_awal=" +
                                p_tanggal_awal +
                ...
                $('.export_pdf').click(function() {
                    // var url = "{{ route('admin.panen.pdf_panen_perkebunan') }}";
