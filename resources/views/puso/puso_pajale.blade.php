        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <form id="form_pdf" action="{{ route('puso.pdf_puso_pajale') }}" method="get" style="display: none;">
                        @csrf
            ...
            <script>
                $(function() {
                    ...
                    .on("click","#btn-search",function (e) {
                        ...
                        $("th#prov").html(null);
                        $("th#harga").html(null);
                        table.ajax.url( "{{ route('puso_pajale.data') }}?tanggal_awal="+p_tanggal_awal+"&tanggal_akhir="+p_tanggal_akhir ).load();
                ...
                function addForm() {
                    var url = "{{ route('puso.create_pajale') }}";
                    $('#modal-form').modal('show');
                    $('#modal-form .modal-title').text('Tambah Data Puso Pajale');
                ...
                function editForm(id_produktivitas_puso) {
                    var url = "{{ url('puso/puso_pajale/update/') }}"+ "/" +id_produktivitas_puso;
                    $('#modal-form').modal('show');
                    $('#modal-form .modal-title').text('Edit Data Puso Pajale');
