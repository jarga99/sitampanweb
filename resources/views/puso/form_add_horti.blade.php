        ...
        <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="lh_habis" class="col-lg-2 col-lg-offset-1 control-label">Luas Puso Habis (ha)</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="lh_blm_habis" class="col-lg-2 col-lg-offset-1 control-label">Luas Puso Belum Habis (ha)</label>
                        <div class="col-lg-6">
