    ...
    <div class="row">
        ...
        @push('scripts')
            ...
            <script>
                $(function() {
                    ...
                    $(document).off("click", "#btn-search")
                        .on("click", "#btn-search", function(e) {
                            ...
                            $("th#prov").html(null);
                            $("th#harga").html(null);
                            table.ajax.url("{{ route('puso_horti.data') }}?tanggal_awal=" + p_tanggal_awal +
                ...
                function addForm() {
                    var url = "{{ route('puso.create_horti') }}";
                ...
                function editForm(id_produktivitas_puso) {
                    var url = "{{ url('puso/puso_horti/update/') }}" + "/" + id_produktivitas_puso;
                    $('#modal-form').modal('show');
                    $('#modal-form .modal-title').text('Edit Data Puso Horti');
