    ...
    <div class="row">
        <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{route('head.tanam.index_pajale')}}" class="small-box-footer"> Detail <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{route('head.tanam.index_horti')}}" class="small-box-footer">  Detail  <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{route('head.tanam.index_perkebunan')}}" class="small-box-footer">  Detail  <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-4 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-orange">
                ...
                <a href="{{route('head.panen.index_pajale')}}" class="small-box-footer">  Detail  <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <!-- Small boxes (Stat box) -->
        <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box bg-orange">
                ...
                <a href="{{route('head.panen.index_horti')}}" class="small-box-footer">  Detail  <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box bg-orange">
                ...
                <a href="{{route('head.panen.index_perkebunan')}}" class="small-box-footer">  Detail  <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-4 col-xs-6">
            <!-- small box -->
