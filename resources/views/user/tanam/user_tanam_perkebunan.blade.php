        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <br> --}}
                    <form id="form_pdf" action="{{ route('user.tanam.pdf_tanam_perkebunan') }}" method="get" style="display: none;">
                        @csrf
        ...
        @push('scripts')
            ...
            <script>
                ...
                $('.export_pdf').click(function() {
                    // var url = "{{ route('user.tanam.pdf_tanam_perkebunan') }}";
