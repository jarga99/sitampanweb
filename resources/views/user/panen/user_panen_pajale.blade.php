        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <br> --}}
                    <form id="form_pdf" action="{{ route('user.panen.pdf_panen_pajale') }}" method="get" style="display: none;">
                        @csrf
            ...
            <script>
                ...
                $(function() {
                    table = $('.table').DataTable({
                        ...
                        autoWidth: false,
                        ajax: {
                            url: '{{ route('user.user_panen_pajale.data') }}',
                        },
                        columns: [{
                                data: 'DT_RowIndex',
                                searchable: false,
                ...
                $('.export_pdf').click(function() {
                    // var url = "{{ route('user.panen.pdf_panen_pajale') }}";
