...
class UserPusoPerkebunanController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('user/puso/user_puso_perkebunan', $data);
    }
    ...
    "));
        ...
        $pdf = Pdf::loadView('user.puso.pdf_puso_perkebunan', compact('produktivitas_puso','total'))->setPaper('a4', 'landscape');
