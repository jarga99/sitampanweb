...
class UserPusoPajaleController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('user/puso/user_puso_pajale', $data);
    }
    ...
    "));
        ...
        $pdf = Pdf::loadView('user.puso.pdf_puso_pajale', compact('produktivitas_puso','total'))->setPaper('a4', 'landscape');
