...
use App\Exports\Pajale_Admin_Export;
use App\Models\Desa;
...
class AdminTanamPajaleController extends Controller
{
    ...
    "));
        ...
        $pdf = Pdf::loadView('admin.tanam.pdf_tanam_pajale', compact('produktivitas_tanam','total'))->setPaper('a4', 'landscape');
    ...
    {
        return (new Pajale_Admin_Export)->setDari($request->form_awal)->setSampai($request->form_akhir)->download('tanam_pajale.xlsx');
    }
}
