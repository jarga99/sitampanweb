...
class TanamPerkebunanController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($produktivitas_tanam) {
                ...
                <button type="button" onclick="deleteData(`' . route('tanam.delete_perkebunan', ['id' => $produktivitas_tanam->id_produktivitas_tanam]) . '`)" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></button>
                </div>
            ';
            return "Ok";
            })
    ...
    "));
        ...
        $pdf = Pdf::loadView('tanam.pdf_tanam_perkebunan', compact('produktivitas_tanam','total'))->setPaper('a4', 'landscape');
