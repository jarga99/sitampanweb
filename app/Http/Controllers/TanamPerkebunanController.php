...
class TanamPerkebunanController extends Controller
{
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($produktivitas) {
                ...
                <button type="button" onclick="deleteData(`' . route('tanam.delete_perkebunan', ['id' => $produktivitas->id_produktivitas]) . '`)" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button>
            ';
            return "Ok";
            })
    ...
    public function pdf_perkebunan(Request $request)
    {
        ...
        $pdf = Pdf::loadView('tanam.pdf_perkebunan', compact('produktivitas'))->setPaper('a4', 'potrait');
