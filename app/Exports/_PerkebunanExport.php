...
class _PerkebunanExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    use Exportable;
    ...
    */
    public function collection()
    {
        ...
        $data =  ProduktivitasPuso::with('mst_tanaman', 'mst_kecamatan', 'mst_desa')->whereIn('tanaman_id', $tanaman);
