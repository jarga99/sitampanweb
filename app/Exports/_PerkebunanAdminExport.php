...
class _PerkebunanAdminExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    use Exportable;
    ...
    */
    public function collection()
    {
        ...
        $data =  ProduktivitasPuso::with('mst_tanaman', 'mst_kecamatan', 'mst_desa')->where('created_by', $user)->whereIn('tanaman_id', $tanaman);
